...
import (
	...
	hellov1beta1 "github.com/u2386/hello-world-operator/pkg/apis/hello/v1beta1"
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &hellov1beta1.HelloWorld{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
	...
	err = c.Watch(&source.Kind{Type: &corev1.Pod{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &hellov1beta1.HelloWorld{},
	})
	if err != nil {
		return err
	}
...
func (r *ReconcileHelloWorld) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	instance := &hellov1beta1.HelloWorld{}
...
func newPodForCR(cr *hellov1beta1.HelloWorld) *corev1.Pod {
	labels := map[string]string{
		"app": cr.Name,
	}

	script := fmt.Sprintf("for i in `seq 100`; do echo $i %s; sleep 1; done;", cr.Spec.Message)
